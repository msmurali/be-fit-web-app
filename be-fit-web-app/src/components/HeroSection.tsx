const HeroSection = () => {
  return (
    <div className="hero-section w-full min-h-screen p-8 lg:px-16 pt-36 lg:pt-48 bg-hero-section bg-right-top bg-cover flex justify-center items-start flex-col text-white font-poppins">
      <div className="hero-section_content w-full md:w-1/2 lg:pb-28">
        ...
        <button className="mt-8 lg:mt-10 px-8 md:px-16 py-3 lg:text-2xl bg-secondary rounded-lg font-medium shadow-md">
          Explore
        </button>
      </div>
    </div>
